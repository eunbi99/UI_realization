   ...
   <header style="padding-bottom: 3px">
      <div class="container text-center">
         ...
         <nav id="fh5co-main-nav" role="navigation" style="font-family: sans-serif">
            <ul class="list_menu">
               <li class="menu lst dropdown"><a href="#" class="active link_menu"><button class="dropbtn" style="margin-left: 0px;">전체 카테고리</button></a>
                  <div class="dropdown-content">
      ...
      <div class="container">
         <div class="row text-center">
            <div class="col-md-4 col-sm-6">
               <div class="fh5co-grid-work">
                  <div class="work-holder">
                     <a href="../detail/detail_veg.jsp"><img src="../assets/images/veg1.png" alt="Work"></a>
                  </div>
                  <div class="desc">
            ...
            <div class="col-md-4 col-sm-6">
               <div class="fh5co-grid-work">
                  <div class="work-holder">
                     <a href="detail_ban.html"><img src="../assets/images/veg2.png" alt="Work"></a>
                  </div>
                  <div class="desc">
            ...
            <div class="col-md-4 col-sm-6">
               <div class="fh5co-grid-work">
                  <div class="work-holder">
                     <a href="detail_ki.html"><img src="../assets/images/veg3.png" alt="Work"></a>
                  </div>
                  <div class="desc">
